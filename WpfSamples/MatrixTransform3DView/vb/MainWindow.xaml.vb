...
Namespace MatrixTransform3DView
	...
	Partial Public Class MainWindow
		Inherits Window
		'Set globals
        Private endMat3D As New Matrix3D()
        ...
        Private Sub UpdateMatrix(ByVal sender As Object, ByVal e As EventArgs)
            Try
                ...
                endMat3D = New Matrix3D(setM11, setM12, setM13, setM14, setM21, setM22, setM23, setM24, setM31, setM32, setM33, setM34, setOffsetX, setOffsetY, setOffsetZ, setM44)

                myMatrixTransform3D.Matrix = endMat3D
            Catch
