...
Namespace Show3DLights
	Public Class MyLights
		' Ambient light value.
		Private _ambLight As New AmbientLight(Brushes.DarkBlue.Color)
		...
		Private _dirLightColor() As Color = { Brushes.White.Color, Brushes.Yellow.Color }
		...
		Public Sub New()
			...
			_ptLight.Color = Brushes.White.Color
			_ptLight.Range = 15.0
