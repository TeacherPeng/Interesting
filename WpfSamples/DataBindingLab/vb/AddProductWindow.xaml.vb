Namespace DataBindingLab
	Partial Public Class AddProductWindow
		...
		Private Sub OnInit(ByVal sender As Object, ByVal e As RoutedEventArgs)
			Me.DataContext = New AuctionItem("Type your description here", ProductCategory.DVDs, 1, Date.Now, (CType(Application.Current, DataBindingLabApp)).CurrentUser, SpecialFeatures.None)
		End Sub
