...
Namespace SortFilterSample
    ...
    Public Class Orders
        ...
        Public o3 As New Order(1003, 5682, "Brown Pant W", 2, "Yes", New Date(2002, 12, 20), New Date(2003, 1, 13))
    ...
    Public Class Order
        ...
        Private customerValue As Integer
        Private nameValue As String
        Private idValue As Integer
        Private filledValue As String
        Private orderDateValue As Date
        Private dateFilledValue As Date
        ...
        Public Property DateFilled() As Date
            Get
                Return dateFilledValue
            End Get
            Set(ByVal value As Date)
                dateFilledValue = value
