...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfOclPlatformInfo : Emgu.Util.UnmanagedObject, IInputOutputArray
   {
	  ...
	  public VectorOfOclPlatformInfo(params OclPlatformInfo[] values)
	     : this()
	  {
         foreach(OclPlatformInfo v in values)
            Push(v);
	  }
      ...
      public void Push(OclPlatformInfo[] values)
      {
         foreach (OclPlatformInfo value in values)
            Push(value);
      }
      ...
      public OclPlatformInfo this[int index]
      {
         get
         {
            ...
            return new OclPlatformInfo(itemPtr, false);
         }
      }
      ...
      {
        return new InputArray( cvInputArrayFromVectorOfOclPlatformInfo(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfOclPlatformInfo(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfOclPlatformInfo(_ptr) );
      }
