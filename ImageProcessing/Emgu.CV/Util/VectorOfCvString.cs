...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfCvString : Emgu.Util.UnmanagedObject, IInputOutputArray
   {
      ...
      {
        return new InputArray( cvInputArrayFromVectorOfCvString(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfCvString(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfCvString(_ptr) );
      }
