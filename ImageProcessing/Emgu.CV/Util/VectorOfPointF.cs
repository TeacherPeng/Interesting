...
namespace Emgu.CV.Util
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfPointF(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfPointF(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfPointF(_ptr) );
      }
