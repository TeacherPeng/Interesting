...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfVectorOfDMatch : Emgu.Util.UnmanagedObject, IInputOutputArray
   {
	  ...
	  public VectorOfVectorOfDMatch(params VectorOfDMatch[] values)
	     : this()
	  {
         foreach(VectorOfDMatch v in values)
            Push(v);
	  }
      ...
      {
        return new InputArray( cvInputArrayFromVectorOfVectorOfDMatch(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfVectorOfDMatch(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfVectorOfDMatch(_ptr) );
      }
