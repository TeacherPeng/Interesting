...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfUMat : Emgu.Util.UnmanagedObject, IInputOutputArray
   {
      ...
      {
        return new InputArray( cvInputArrayFromVectorOfUMat(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfUMat(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfUMat(_ptr) );
      }
