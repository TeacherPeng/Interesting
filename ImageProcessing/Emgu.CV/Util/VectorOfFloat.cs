...
namespace Emgu.CV.Util
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfFloat(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfFloat(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfFloat(_ptr) );
      }
