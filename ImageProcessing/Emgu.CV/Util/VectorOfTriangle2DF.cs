...
namespace Emgu.CV.Util
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfTriangle2DF(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfTriangle2DF(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfTriangle2DF(_ptr) );
      }
