...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfVectorOfPoint : Emgu.Util.UnmanagedObject, IInputOutputArray
   {
	  ...
	  public VectorOfVectorOfPoint(params VectorOfPoint[] values)
	     : this()
	  {
         foreach(VectorOfPoint v in values)
            Push(v);
	  }
      ...
      {
        return new InputArray( cvInputArrayFromVectorOfVectorOfPoint(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfVectorOfPoint(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfVectorOfPoint(_ptr) );
      }
