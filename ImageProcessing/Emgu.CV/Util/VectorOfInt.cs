...
namespace Emgu.CV.Util
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfInt(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfInt(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfInt(_ptr) );
      }
