...
namespace Emgu.CV.Util
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfRect(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfRect(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfRect(_ptr) );
      }
