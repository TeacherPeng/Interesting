...
namespace Emgu.CV.Util
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfByte(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfByte(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfByte(_ptr) );
      }
