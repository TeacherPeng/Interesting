...
namespace Emgu.CV.Text
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfERStat(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfERStat(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfERStat(_ptr) );
      }
