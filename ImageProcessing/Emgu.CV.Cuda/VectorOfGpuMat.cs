...
namespace Emgu.CV.Cuda
{
   ...
   public partial class VectorOfGpuMat : Emgu.Util.UnmanagedObject, IInputOutputArray
   {
      ...
      {
        return new InputArray( cvInputArrayFromVectorOfGpuMat(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfGpuMat(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfGpuMat(_ptr) );
      }
