...
namespace Emgu.CV.OCR
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfTesseractResult(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfTesseractResult(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfTesseractResult(_ptr) );
      }
